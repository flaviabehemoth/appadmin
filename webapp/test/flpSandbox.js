		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#Adminappadmin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Adminappadmin-display": {
								"semanticObject": "Adminappadmin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Admin.appadmin",
									"url": sap.ui.require.toUrl("Admin/appadmin")
								}
							}
						}
					}
